...
class Client extends core_1.BaseClient {
    ...
    /** csrf token */
    get bkn() {
        return (0, common_1.calcBkn)(this.sig.skey);
    }
    /** 数据统计 */
    get stat() {
    ...
    constructor(uin, conf) {
        ...
        this.g_tk = new Proxy(this.pskey, {
            get: (obj, domain) => {
                return obj[domain] ? (0, common_1.calcBkn)(obj[domain]) : 0;
            },
            set: () => {
                return false;
            },
        ...
        this.logger = log4js_1.default.getLogger("[icqq]");
        if (typeof uin === "number")
            this.uin = uin;
    ...
    getClientKey() {
        return internal_1.getClientKey.call(this);
    }
    getPSkey(domains) {
        return internal_1.getPSkey.call(this, domains);
    }
    refreshNTPicRkey(force = false) {
        return internal_1.refreshNTPicRkey.call(this, force);
    }
    uid2uin(uid, group_id) {
        return internal_1.uid2uin.call(this, uid, group_id);
    }
    uid2uins(uids, group_id) {
        return internal_1.uid2uins.call(this, uids, group_id);
    }
    uin2uid(uin, group_id) {
        return internal_1.uin2uid.call(this, uin, group_id);
    }
    uin2uids(uins, group_id) {
        return internal_1.uin2uids.call(this, uins, group_id);
    }
    getStatusInfo(uin, usejce) {
        return internal_1.getStatusInfo.call(this, uin, usejce);
    }
    /** 获取在线状态 */
    getOnlineStatus() {
        return internal_1.getStatus.call(this);
    }
    /** 设置在线状态 */
    ...
    async getProfile(uin_uid, idsParse) {
        return await internal_1.getUserProfile.call(this, uin_uid, idsParse);
    }
    /** 设置头像 */
    async setAvatar(file) {
        return internal_1.setAvatar.call(this, new message_1.Image(this, { type: "image", file }));
    }
    /** 获取漫游表情 */
    ...
    /** Ocr图片转文字 */
    imageOcr(file) {
        return internal_1.imageOcr.call(this, new message_1.Image(this, { type: "image", file, nt: false }));
    }
