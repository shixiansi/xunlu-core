...
export declare class Group extends Discuss {
    ...
    private _fetchMemberOidb;
    private old_fetchMembers;
    /** 获取群员列表 */
    ...
    getFileInfo(fid: string): Promise<import("./gfs").GfsFileStat | import("./gfs").GfsDirStat>;
    /**
     * 上传一个文件
     ...
     * @returns 上传的文件属性
     */
    uploadFile(file: string | Buffer | File, pid?: string, name?: string, callback?: (percentage: string) => void): Promise<import("./gfs").GfsFileStat>;
    /**
     * 发送一个文件
     * @param file `string`表示从该本地文件路径上传，`Buffer`表示直接上传这段内容
     * @param pid 上传的目标目录id，默认根目录
     ...
     * @returns 上传的文件属性
     */
    sendFile(file: string | Buffer | File, pid?: string, name?: string, callback?: (percentage: string) => void): Promise<import("./gfs").GfsFileStat>;
    /**
     * 发送一条消息
     * @param content 消息内容
