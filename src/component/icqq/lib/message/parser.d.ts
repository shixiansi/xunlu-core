...
import { Client } from "..";
/** 解析消息 */
export declare function parse(client: Client, rich: pb.Proto | pb.Proto[], uin?: number): Parser;
/** 消息解析器 */
export declare class Parser {
    ...
    private exclusive;
    private it?;
    constructor(client: Client, rich: pb.Proto | pb.Proto[], uin?: number | undefined);
    /** 获取下一个节点的文本 */
    private getNextText;
