...
exports.createMultiMsgJson = createMultiMsgJson;
exports.parseMultiMsg = parseMultiMsg;
exports.parseShareMsg = parseShareMsg;
...
class Converter {
    ...
    face(elem) {
        ...
        let faceObj = face_1.facemap[id] ||
            Object.entries(face_1.facemap)
                .map(([id, obj]) => {
                return { id, ...obj };
            })
    ...
    image(elem) {
        const img = new image_1.Image(this.client, elem, this.ext?.dm, this.ext?.cachedir);
        this.imgs.push(img);
    ...
    record(elem) {
        ...
        const proto = core_1.pb.decode(buf);
    ...
    json(elem) {
        ...
        this.elems.push({
            51: {
                1: Buffer.concat([
                    BUF1,
                    (0, zlib_1.deflateSync)(JSON.stringify(json)),
                ]),
            },
        });
...
function createMultiMsgJson(elem) {
