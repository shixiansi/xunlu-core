...
import { lock, parseFunString, timestamp } from "../common.mjs";
...
/** @cqhttp 生成私聊消息id */
export function genDmMessageId(uin, seq, rand, time, flag = 0) {
...
/** @cqhttp 生成群消息id */
export function genGroupMessageId(gid, uin, seq, rand, time, pktnum = 1) {
            ...
            case 529:
                if (this.head[nt ? 3 : 4] === 4) {
                    ...
                    const elem = {
                        ...
                        size: trans[6],
                        md5: trans[4]?.toHex() || "",
                        duration: trans[51] || (trans[55] > 0 ? trans[55] - timestamp() : 0),
                        fid: String(trans[3]),
                    };
                    this.message = [elem];
