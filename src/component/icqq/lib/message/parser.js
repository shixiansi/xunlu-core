...
/** 解析消息 */
function parse(client, rich, uin) {
...
class Parser {
    ...
    parseExclusiveElem(type, proto) {
        ...
        switch (type) {
            ...
            case 51: //json
                ...
                brief = elem.type + "消息";
                const multimsg_elem = (0, converter_1.parseMultiMsg)(elem);
                if (multimsg_elem) {
                    elem = multimsg_elem;
                    ...
                    if (elem.type === "json") {
                        const share = (0, converter_1.parseShareMsg)(elem);
                        if (share)
            ...
            case 5: //transElem
                ...
                elem = {
                    ...
                    md5: String(trans[8]),
                    size: trans[3],
                    duration: trans[5] > 0 ? (trans[5] - (0, common_1.timestamp)()) : trans[5],
                };
                brief = "[文件]" + elem.name;
    ...
    parseNewImgElem(businessType, proto, type) {
        try {
            ...
            elem.file = (0, image_1.buildImageFileParam)(elem.md5, elem.sha1, elem.size, elem.width, elem.height, proto[1][1][1][5][2]);
    ...
    parseImgElem(source_type, proto, type) {
        ...
        if (this.imgprefix[md5] && path?.length) {
            ...
            elem.file = (0, image_1.buildImageFileParam)(elem.md5, elem.sha1, elem.size, elem.width, elem.height, proto[dm ? 5 : 20]);
            elem.name = elem.file;
        }
        if (type === "image")
