...
export declare abstract class Message implements Quotable, Forwardable {
    ...
    constructor(client: Client, proto: pb.Proto, nt: boolean | undefined);
    /** 将消息序列化保存 */
    serialize(): Buffer;
    /** 以适合人类阅读的形式输出 */
    toString(): string;
...
export declare class PrivateMessage extends Message {
    ...
    constructor(client: Client, proto: pb.Proto, uin?: number, nt?: boolean);
}
/** 一条群消息 */
export declare class GroupMessage extends Message {
    ...
    /** 反序列化一条群消息 */
    static deserialize(client: Client, serialized: Buffer): GroupMessage;
    constructor(client: Client, proto: pb.Proto, nt?: boolean);
}
/** 一条讨论组消息 */
...
export declare class ForwardMessage implements Forwardable {
    ...
    sub_type?: "friend" | "group" | "other" | "self" | "friend" | "normal" | "anonymous";
    /** 账号 */
    user_id: number;
    /** uid */
    user_uid?: string;
    ...
    raw_message: string;
    /** 反序列化一条转发消息 */
    static deserialize(client: Client, serialized: Buffer, nt?: boolean): ForwardMessage;
    constructor(client: Client, proto: pb.Proto, nt: boolean | undefined);
    /** 将转发消息序列化保存 */
    serialize(): Buffer;
    /** 以适合人类阅读的形式输出 */
