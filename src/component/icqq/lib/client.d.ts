...
export declare class Client extends BaseClient {
    ...
    getClientKey(): Promise<{
        client_key: string;
        expire_time: number;
    }>;
    getPSkey(domains: string | string[]): Promise<{
        domain: string;
        p_skey: string;
        expire_time: number;
        g_tk: number;
    ...
    refreshNTPicRkey(force?: boolean): Promise<{
        [type: number]: import("./core").RkeyInfo;
    }>;
    uid2uin(uid: string, group_id?: number | undefined): Promise<number>;
    uid2uins(uids: string[], group_id?: number | undefined): Promise<number[]>;
    uin2uid(uin: number, group_id?: number | undefined): Promise<string>;
    uin2uids(uins: number[], group_id?: number | undefined): Promise<string[]>;
    getStatusInfo(uin?: number, usejce?: boolean): Promise<import("./common").StatusInfo | null>;
    /** 获取在线状态 */
     ...
     */
    getProfile(uin_uid: number | string, idsParse?: Record<number, {
        key: string;
        parse: (val: any) => any;
