...
exports.BaseClient = exports.SSOErrorCode = exports.QrcodeResult = exports.NTLoginErrorCode = exports.ApiRejection = exports.VerboseLevel = void 0;
exports.buildPacket = buildPacket;
exports.buildLoginPacket = buildLoginPacket;
exports.decryptLoginPacket = decryptLoginPacket;
exports.buildNTLoginPacket = buildNTLoginPacket;
exports.decryptNTLoginPacket = decryptNTLoginPacket;
exports.buildLoginTLV = buildLoginTLV;
exports.buildTransPacket = buildTransPacket;
exports.buildCode2dPacket = buildCode2dPacket;
exports.buildQrcodePacket = buildQrcodePacket;
exports.buildReserveField = buildReserveField;
exports.decodeT119 = decodeT119;
exports.decodeLoginResponse = decodeLoginResponse;
exports.decodeNTLoginResponse = decodeNTLoginResponse;
...
const import_sign = __importStar(require("./sign"));
const import_qsign = __importStar(require("./qsign"));
...
})(NTLoginErrorCode || (exports.NTLoginErrorCode = NTLoginErrorCode = {}));
var QrcodeResult;
...
class BaseClient extends triptrap_1.Trapper {
    ...
    constructor(p = device_1.Platform.Android, d, config) {
        ...
        this[_d] = (0, timers_1.setInterval)(this[MergeSendListHandler], 1000);
        this[_e] = new ecdh_1.default();
        this[_f] = new network_1.default();
        // 回包的回调函数
        this[_g] = new Map();
        this.sig = new Proxy({
            ...
            d2_key_old: constants_1.BUF16,
            tlvs: {
                0x103: constants_1.BUF0,
                0x104: constants_1.BUF0,
                0x106: constants_1.BUF0,
                0x108: constants_1.BUF0,
                0x10a: constants_1.BUF0,
                0x10c: constants_1.BUF0,
                0x10d: constants_1.BUF0,
                0x10e: constants_1.BUF0,
                0x114: constants_1.BUF0,
                0x120: constants_1.BUF0,
                0x133: constants_1.BUF0,
                0x134: constants_1.BUF0,
                0x143: constants_1.BUF0,
                0x16a: constants_1.BUF0,
                0x174: constants_1.BUF0,
                0x305: constants_1.BUF0,
                0x322: constants_1.BUF0,
                0x402: constants_1.BUF0,
                0x403: constants_1.BUF0,
                0x512: constants_1.BUF0,
                0x543: constants_1.BUF0,
                0x546: constants_1.BUF0,
                0x547: constants_1.BUF0,
                0x550: constants_1.BUF0,
                0x553: constants_1.BUF0,
            },
            nt_captcha: null,
            nt_session: {
                key: constants_1.BUF0,
                ticket: constants_1.BUF0,
                expire_time: 0
            },
        ...
        if (config.log_config)
            log4js_1.default.configure(config.log_config);
    ...
    getApkInfoList(platform) {
        return device_1.getApkInfoList.call(this, platform);
    }
    ...
    /** 使用接收到的token登录 */
    async tokenLogin(token = constants_1.BUF0, subcmd = 15) {
        if (token?.length) {
            ...
            try {
                ...
                if ((String(info) || "").includes("icqq")) {
                    ...
                    if (info.token_ver <= 3 || !this.sig.a1_key?.length) {
                        subcmd = 11;
                        this.sig.tgtgt = (0, constants_1.md5)(this.sig.d2_key);
                    }
                    if (info.token_ver >= 5 &&
                    ...
                    if (this.sig.token_retry_count === 0 && info.token_ver >= 3) {
                        ...
                        if (ret === 1) {
                            ...
                            this.emit("internal.online", constants_1.BUF0, nickname);
                        }
                        else {
        ...
        subcmd =
            this.sig.srm_token?.length && this.sig.a1?.length && this.sig.a1_key?.length
                ? subcmd
                : 11;
        this.sig.tgtgt = subcmd === 15 ? this.sig.a1_key : (0, constants_1.md5)(this.sig.d2_key);
        const tlvs = [
            [0x8],
            [0x18],
            [0x100],
    ...
    async submitSlider(ticket) {
        ...
        try {
            if (this.sig.t546.length)
                this.sig.t547 = constants_1.calcPoW.call(this, this.sig.t546);
        }
        catch (err) {
            this.sig.t547 = constants_1.BUF0;
        }
    ...
    async fetchQrcode() {
        ...
        this.sendPacket(pkt, 6, -1, { cmd: "wtlogin.trans_emp", type: 0xa, encrypt: 0x2 })
            ...
            if (retcode === 0) {
                stream.read(2);
                const t = (0, constants_1.readTlv)(stream);
                if (t[0x17]) {
    ...
    async fetchLogin(sig) {
        ...
        return { retcode: -1, qrsig: constants_1.BUF0 };
    }
    /** 扫码后调用此方法登录 */
    async qrcodeLogin() {
    ...
    async keyExchange() {
        ...
        const gcmCalc1 = (0, constants_1.aesGcmEncrypt)(plain1, this[ECDH].nt_share_key);
        const ts = Date.now();
        ...
        this.sig.nt_session = {
            ...
            expire_time: (0, constants_1.timestamp)() + pbDecrypted[3]
        };
    ...
    sendMergeUni(list, timeout = 6, extra) {
        ...
        const body = (0, zlib_1.deflateSync)(pb.encode({
            1: list.map(val => {
                return {
                    1: val.seq,
                    2: val.cmd,
        ...
        return new Promise((resolve, reject) => {
            if (timeout) {
                const respList = list.map(val => {
                    return { seq: val.seq, cmd: val.cmd, payload: constants_1.BUF0, recv: false };
                });
    ...
    syncTimeDiff() {
        if (!this[IS_ONLINE])
            return;
        const seq = this[FN_NEXT_SEQ]();
        this.sendPacket(constants_1.BUF4, 6, seq, { cmd: "Client.CorrectTime", type: 0xa, encrypt: 0x0 })
            .then(buf => {
            try {
        ...
        return new Promise((resolve, reject) => {
            ...
            const success = (payload) => {
                ...
                if (time - this.sig.hb_time >= 300) {
                    ...
                    if (!this.useQQNT)
                        this.writeUni("StatSvc.SimpleGet", constants_1.BUF0);
            ...
            const seq = this[FN_NEXT_SEQ]();
            this.sendPacket(constants_1.BUF0, 10, seq, { cmd: "Heartbeat.Alive", type: 0xa, encrypt: 0x0 })
                .then(success)
                .catch(e => {
    ...
    sendSsoHeartBeat() {
        ...
        return new Promise(async (resolve, reject) => {
            this.sendUni("trpc.qq_new_tech.status_svc.StatusService.SsoHeartBeat", this.sig.ssoHeartBeat(), 6, { message_type: 32 })
                .then(payload => {
                this.sig.last_sso_heartbeat = (0, constants_1.timestamp)();
    ...
    generateT544Packet(cmd, sign) {
        ...
        if (!sign?.length)
            sign = constants_1.BUF0; //return getLocalT544(cmd);
        ...
        case "ConfigPushSvc.PushReq":
            {
                ...
                if (nested[1] === 2 && nested[2]) {
                    ...
                    try {
                        ...
                        this.sig.bigdata.sig_session = constants_1.BUF0;
                        this.sig.bigdata.session_key = constants_1.BUF0;
...
async function parseSso(buf) {
    ...
    const header = stream_1.Readable.from(stream.read(stream.read(4).readUInt32BE() - 4) || constants_1.BUF0, { objectMode: false });
    ...
    const reserve = header.read(header.read(4).readUInt32BE() - 4) || constants_1.BUF0;
...
async function packetListener(pkt) {
    ...
    try {
        ...
        const trpc_rsp = (0, constants_1.parseTrpcRsp)(sso.reserve);
...
async function register(logout = false, reflush = false) {
    ...
    try {
        ...
        const body = !logout ? {
            1: 1759,
            2: crypto_1.default.randomBytes(4).readUInt32BE(),
            4: 2,
            5: 0,
            6: {
                1: {},
        ...
        if ((!proto[7]?.[2] || proto[7][2].toString() !== "register success") && !reflush) {
            ...
            this.startSsoHeartBeat();
            if (this.interval > 0) {
                this[HEARTBEAT] = (0, timers_1.setInterval)(() => {
...
async function refreshToken(force = false) {
    if ((!this.isOnline() ||
        this.emp_interval === 0 ||
        (0, constants_1.timestamp)() - this.sig.emp_time < this.emp_interval) &&
        !force)
        return;
    const seq = this[FN_NEXT_SEQ]();
    try {
        ...
        if (this.apk.appid !== 16 && this.sig.useNTLogin) {
            ...
            stream.read(2);
            t = (0, constants_1.readTlv)(stream);
        }
...
async function buildPacket(type, encrypt, cmd, body, seq, extra) {
    ...
    if ([0xa, 0xb, 0xd].includes(type) &&
        ...
        if (!sec_info?.length && this.sig.sign_api_addr && this.apk.fekit_ver)
            throw new ApiRejection(errors_1.ErrorCode.SignApiError, "签名api异常");
    }
    switch (type) {
        case 0xa: {
            const ksid = Buffer.from(`||` + this.apk.name);
            sso = new writer_1.default()
    ...
    return new writer_1.default()
        ...
        ? new writer_1.default().writeWithLength(this.sig.d2)
        : new writer_1.default().writeU32(seq)).read())
        .writeU8(0)
...
function buildLoginPacket(cmdid, body) {
    if (!cmdid)
...
function decryptLoginPacket(payload) {
    return tea.decrypt(payload.slice(16, -1), this[ECDH].share_key);
}
async function buildNTLoginPacket(cmd, params = {}) {
    const uin = this.uin;
    if (!this.device.qImei36 || !this.device.qImei16)
        await this.device.getQIMEI();
    if (!this.sig.nt_session || this.sig.nt_session.expire_time - (0, constants_1.timestamp)() < 60)
    ...
    const head = {
        ...
        2: {
            1: String(device_1.NTLoginPlatform[this.apk.login_platform]).toUpperCase(),
            2: this.device.model,
    ...
    const encrypted = (0, constants_1.aesGcmEncrypt)(pb.encode(this.apk.appid === 16 ? { 2: proto, 3: { 1: 0, 2: String(uin) } } : proto), this.sig.nt_session.key);
...
function decryptNTLoginPacket(payload) {
    if (!this.sig.nt_session)
        return constants_1.BUF0;
    const decrypted = (0, constants_1.aesGcmDecrypt)(pb.decode(payload)[this.apk.appid === 16 ? 5 : 3].toBuffer(), this.sig.nt_session.key);
    return this.apk.appid === 16 ? pb.decode(decrypted)[2].toBuffer() : decrypted;
}
async function buildLoginTLV(subcmd, add_tlvs, use544 = true, t544cmd) {
    if (!this.device.qImei36 || !this.device.qImei16) {
        await this.device.getQIMEI();
    }
    const t = tlv.getPacker(this);
    ...
    let writer = new writer_1.default().writeU16(subcmd).writeU16(tlvs.length);
    for (let tlv of tlvs) {
        writer.writeBytes(tlv);
    }
    return writer.read();
}
function buildTransPacket(appid, role, body, encrypt) {
    body = new writer_1.default().writeU32((0, constants_1.timestamp)()).writeBytes(body).read();
...
function buildCode2dPacket(cmdid, enable_close, body, seq = this.sig.seq) {
...
function buildQrcodePacket(cmdid, body, seq = this[FN_NEXT_SEQ]()) {
    if (typeof seq !== "number" || seq < 0)
        seq = this[FN_NEXT_SEQ]();
...
function buildReserveField(cmd, sec_info, extra) {
    extra || (extra = {});
...
function decodeT119(t119, key = null) {
    ...
    const r = stream_1.Readable.from(tea.decrypt(Buffer.from(t119), Buffer.from(t119key)), {
        objectMode: false,
    });
    r.read(2);
    const t = (0, constants_1.readTlv)(r);
    return parseToken.call(this, t, 0);
}
function parseToken(t, type) {
    this.sig.emp_time = (0, constants_1.timestamp)();
    this.sig.d2_key_old = this.sig.d2_key.length ? this.sig.d2_key : constants_1.BUF16;
    const info = {
    ...
    switch (type) {
        case 0: {
            for (let tag in t) {
                this.sig.tlvs[tag] = t[tag] || this.sig.tlvs[tag] || constants_1.BUF0;
            }
            if (t[0x543]?.length) {
                try {
        ...
        case 2: {
            try {
                const stream = stream_1.Readable.from(t, { objectMode: false });
                ...
                if (token_info.token_ver < 6) {
                    ...
                    if (this.sig.tlvs[0x512].length) {
                        const r = stream_1.Readable.from(this.sig.tlvs[0x512], { objectMode: false });
                        let len = r.read(2).readUInt16BE();
                        while (len-- > 0) {
                            const domain = String(r.read(r.read(2).readUInt16BE()));
                            this.pskey[domain] = r.read(r.read(2).readUInt16BE());
    ...
    this.sig.tgtgt = this.sig.a1_key.length ? this.sig.a1_key : (this.sig.d2_key.length ? (0, constants_1.md5)(this.sig.d2_key) : constants_1.BUF16);
...
function decodeLoginResponse(cmd, payload) {
    payload = decryptLoginPacket.call(this, payload);
    ...
    if (type === 237) {
        const proto = pb.decode(t[0x543] || constants_1.BUF0);
...
function decodeNTLoginResponse(cmd, payload) {
    ...
    switch (code) {
        case NTLoginErrorCode.Success: {
            ...
            if (this.apk.appid === 16)
                return this.tokenLogin(constants_1.BUF0).then(body => this[FN_SEND_LOGIN]("wtlogin.exchange_emp", body));
            const { nickname } = info.user;
            this.register().then(async (ret) => {
                if (this[IS_ONLINE]) {
                    this.sig.register_retry_count = 0;
