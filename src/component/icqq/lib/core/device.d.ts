...
export declare enum NTLoginPlatform {
    Unknown = 0,
    iPhone = 1,
    Android = 2,
    Symbian = 3,
...
export type Apk = {
    ...
    ssover: number;
    client_ver: number;
    login_platform: NTLoginPlatform;
    /** 用于扫码登录 */
    device_type: number;
    qr_appid?: number;
    /** fekit_ver参数存在时走SignApi */
    fekit_ver?: string;
};
export declare function getApkInfoList(this: BaseClient, p: Platform): Apk[];
