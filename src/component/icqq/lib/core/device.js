...
exports.NTLoginPlatform = exports.Platform = exports.Device = void 0;
...
-----END PUBLIC KEY-----`;
    ...
    genRandomPayloadByDevice() {
        ...
        let beaconIdArr = [
            ...
            mtimeStr1,
            "0000000000000000",
            (0, constants_1.md5)(this.android_id + this.imei)
                .toString("hex")
                .slice(0, 16),
...
})(NTLoginPlatform || (exports.NTLoginPlatform = NTLoginPlatform = {}));
;
var MainSigMaps;
...
function readCustomApkInfoList() {
    ...
    const apkInfoListPath = /^\d{5,10}|undefined$/.test(path_1.default.basename(this.config.data_dir))
        ? path_1.default.resolve(this.config.data_dir, "../custom-apks.json")
        : path_1.default.join(this.config.data_dir, "custom-apks.json");
    try {
        let apkInfoList = [defaultApkInfo];
        if (!fs_1.default.existsSync(apkInfoListPath)) {
            if (!fs_1.default.existsSync(path_1.default.dirname(apkInfoListPath)))
                fs_1.default.mkdirSync(path_1.default.dirname(apkInfoListPath), { recursive: true });
            fs_1.default.writeFileSync(apkInfoListPath, JSON.stringify([defaultApkInfo], null, 1));
            setTimeout(() => {
                this.emit("internal.verbose", "创建了自定义版本信息文件：" + apkInfoListPath, base_client_1.VerboseLevel.Mark);
            }, 500);
        }
        else {
            apkInfoList = JSON.parse(fs_1.default.readFileSync(apkInfoListPath).toString());
        }
