...
import { timestamp, parseFunString, NOOP, lock, hide } from "./common.mjs";
import { User } from "./friend.mjs";
import { uin2uid } from "./internal/index.mjs";
...
export class Member extends User {
    ...
    async renew() {
        ...
        let info = {
            ...
            user_uid: (await uin2uid.call(this.c, this.uin, this.gid)) || "",
        };
    ...
    async setCard(card = "") {
        const MGCREQ = jce.encodeStruct([
            ...
            this.gid,
            0,
            [jce.encodeNested([this.uin, 31, String(card), 0, "", "", ""])],
        ]);
    ...
    async mute(duration = 1800) {
        ...
        return pb.decode(await this.c.sendOidb("OidbSvc.0x570_8", buf))?.[3] === 0;
    }
    /** 戳一戳 */
    async poke() {
        const body = pb.encode({
