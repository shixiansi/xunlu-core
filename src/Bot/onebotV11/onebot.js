...
// ==================== 初始化示例（可选，外部使用） ====================
// const bot = new OneBotV11Adapter({
//   wsPort: 2955,
//   wsPath: "/OneBotV11",
// })
...
//   // 回复消息
//   bot.sendMsg({ group_id: event.group_id }, `收到：${event.raw_message}`)
// })

// 测试发送合并转发消息
// bot.on("meta_event", async () => {
//   if (bot.isConnected) {
//     try {
//       const result = await bot.sendGroupForwardMsg({
//         group_id: 629661253,
//         messages: [
//           {
//             type: "node",
...
//                   type: "image",
//                   data: {
//                     file: "https://img.shithink.xyz/img-original/img/2020/04/16/20/59/17/80835598_p0.jpg",
//                   },
//                 },
//               ],
//             },
