...
import { coerceToUniversalMessage } from "../context/message-coerce.js"
import { UniversalSegmentType } from "../core/segment-types.js"
...
async function simulateIncomingEvent({
  bot,
  protocol,
  adapterType,
  event,
...
export { renderUniversalSegments, simulateIncomingEvent, simulateIncomingMessage }
